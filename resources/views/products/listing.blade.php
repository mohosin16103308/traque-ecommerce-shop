      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">{{$listing_categories->name}}</h2>
                  ...
                  <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      @if(empty($product->image))
                        ...
                        <img  src="{{ asset('images/backend_images/products/small/fake_avatar/p6.jpg')}}">
                      ...
                      <a href="{{$product->url}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
